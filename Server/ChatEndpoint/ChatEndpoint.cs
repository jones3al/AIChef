...
namespace AIChef.Server.ChatEndpoint
{
    public class ChatRequest
    {
        ...
        /// <summary>
        /// A list of tools the model may generate JSON inputs for. Replaces the
        /// deprecated "functions" parameter.
        /// </summary>
        public ChatTool[]? Tools { get; set; }

        /// <summary>
        /// Controls how the model responds to tool calls. <br />
        /// "none": model will not call a tool <br />
        /// "auto": default if tools are present - model may pick a tool or may generate a message for the user <br />
        /// {"type": "function", "function": {"name": "tool_name"}}: forces the model to call that tool <br />
        /// Replaces the deprecated "function_call" parameter.
        /// </summary>
    ...
    public class ChatMessage
    {
        ...
        /// <summary>
        /// The tools the model would like to call, as generated by the model.
        /// Replaces the deprecated "function_call" response property.
        /// </summary>
    ...
    {
        /// <summary>
        /// The type of tool. Only "function" is currently supported.
        /// </summary>
        public string Type { get; set; } = "function";

        /// <summary>
        /// The function definition this tool exposes to the model
        /// </summary>
    ...
    {
        /// <summary>
        /// The ID of this tool call, used to correlate a tool result back to the call
        /// </summary>
        public string? Id { get; set; }

        /// <summary>
        /// The type of tool being called - "function"
        /// </summary>
        public string? Type { get; set; }

        /// <summary>
        /// The name and arguments of the function the model would like to call
        /// </summary>
        public ChatFunctionResponse? Function { get; set; }
    }
    ...
    public class ChatFunction
    {
        ...
        /// <summary>
        /// When true, the model is constrained to emit arguments that match the schema
        /// exactly, rather than merely being asked to. Requires every object in the schema
        /// to set additionalProperties false and to list all of its properties as required.
        /// </summary>
        ...
        public class Parameter
        {
            ...
            /// an object type. Strict mode requires this to list every property.
            /// </summary>
            public string[]? Required { get; set; }

            /// <summary>
            /// Whether properties beyond those declared are permitted. Strict mode
            /// requires this to be false on every object in the schema.
            /// </summary>
    ...
    /// <summary>
    /// Envelope matching the "data" wrapper the tool schema requires, since the
    /// arguments object cannot be a bare array.
    /// </summary>
